...
function readDir (root, options) {
  ...
  for (const entry of entries) {
    ...
    // this is to skip coverage complaints for the missing bare else statement
    // however we intentionally leave it off, because we do nothing if neither
    // isDirectory() or isFile() is true
